        ...
        <Section>
          <Article id="2b172480-f416-4b5e-b8c7-86d6c446ffc5">
            ...
            <P>
              ...
              app, and you also shouldn’t try to translate thee app into other
              ...
              property rights related to it, still belong to Tijs Martens.
            </P>
            <P>
              Tijs Martens is committed to ensuring that the app is as useful
            ...
            <P>
              The Rodi app stores and processes personal data that you have
              ...
              security features and it could mean that the Rodi app won’t work
              properly or at all.
            </P>
            <P>
            ...
            <ul>
              <Li>
                <A href="https://sentry.io/terms/">Sentry</A>
              </Li>
            </ul>
            <ul>
              <Li>
            ...
            <ul>
              <Li>
                <A href="https://www.strava.com/legal/terms">Strava</A>
              </Li>
            </ul>
            <P>
              You should be aware that there are certain things that Tijs
              Martens will not take responsibility for. Certain functions of the
              ...
              provider, but Tijs Martens cannot take responsibility for the app
            ...
            <P>
              Along the same lines, Tijs Martens cannot always take
              ...
              and you can’t turn it on to avail the Service, Tijs Martens cannot
              accept responsibility.
            </P>
            <P>
              With respect to Tijs Martens’s responsibility for your use of the
              ...
              information to us so that we can make it available to you. Tijs
              Martens accepts no liability for any loss, direct or indirect, you
            ...
            <P>
              ...
              download the updates if you want to keep using the app. Tijs
              Martens does not promise that it will always update the app so
            ...
            <P>These terms and conditions are effective as of 2021-04-03</P>
            <P>
